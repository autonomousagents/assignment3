...
\includegraphics[bb = 1.1in 2.3in 8in 8.5in,clip,width=0.7\textwidth]{IQLpercentageWinning5000episodesavg200trials.pdf} 
\caption{Performance for uniform input data for a GP trained on the \code{chirps.mat} data}
\label{randomPerformance}
\end{figure}
